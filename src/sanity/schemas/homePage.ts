      ...
      fields: [
        {
          ...
          type: 'image',
          description: 'Upload exactly ONE image for desktop screens (Recommended aspect ratio 16:9, e.g. 1920x1080px).',
          options: {
            hotspot: true,
          },
        },
        {
          name: 'mobileImages',
          title: 'Mobile Hero Images (Carousel)',
          type: 'array',
          description: 'Upload images for mobile screens (Required aspect ratio: 4:5 fixed, 1080 × 1350 px). Multiple images will be displayed as an auto-playing carousel on mobile.',
          of: [
            {
              type: 'image',
              options: {
