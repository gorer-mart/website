...
const HomeClient: React.FC<HomeClientProps> = ({ topPicks, newArrivals }) => {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* Top Picks Section */}
      <section className="py-12 px-6 md:py-20 md:px-12 lg:px-24 bg-white" aria-labelledby="top-picks-heading">
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center mb-16 text-center md:text-left">
            ...
            >
              <Button asChild>
                <Link href="/shop" aria-label="View all most popular products">View All</Link>
              </Button>
            </motion.div>
          </div>
      ...
      <section className="py-12 px-6 md:py-20 md:px-12 lg:px-24 bg-neutral-50" aria-labelledby="new-arrivals-heading">
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center mb-16 text-center md:text-left">
            <div className="max-w-xl">
              <motion.h2
            ...
            >
              <Button asChild>
                <Link href="/shop" aria-label="View all new arrival products">View All</Link>
              </Button>
            </motion.div>
          </div>
      ...
      <section className="section-padding bg-[#fff8e9] text-white overflow-hidden relative border-t-6 border-b-6 border-[#a6101b]" aria-labelledby="philosophy-heading">
        <div className="container mx-auto relative z-10">
                ...
                >
                  <div className="flex flex-row md:flex-col-reverse justify-between items-center md:items-start gap-4 md:gap-0 mb-6 md:mb-0">
                    ...
                    <div className="w-10 h-10 md:w-16 md:h-16 rounded-full bg-black/60 md:bg-black/50 flex items-center justify-center md:mb-8 shrink-0">
                      <FontAwesomeIcon icon={item.icon} className="text-lg md:text-2xl text-[#fff8e9]" aria-hidden="true" />
                    </div>
                  </div>
      ...
      <section className="py-24 bg-white relative px-6 md:px-12 lg:px-24" aria-labelledby="community-heading">
        <div className="container mx-auto">
          ...
          <div className="relative flex items-center justify-center">
            ...
            >
              <FontAwesomeIcon icon={faChevronLeft} className="text-sm" aria-hidden="true" />
            </button>
                ...
                >
                  <div className="relative z-10">
                    <div className="text-accent/20 mb-4 group-hover:text-[#d8cd91] transition-colors">
                      <FontAwesomeIcon icon={faQuoteLeft} className="text-2xl" aria-hidden="true" />
                    </div>
                  ...
                  <div className="flex items-center mt-auto relative z-10 pt-4 border-t border-neutral-50">
                    ...
                    <div>
                      <h3 className="font-bold text-sm uppercase tracking-widest text-black">{feedback.name}</h3>
                    </div>
                  </div>
                </article>
              ))}
          ...
          <div className="hidden md:flex space-x-4 mt-8 md:mt-0 justify-end">
            <button
              ...
              aria-label="Previous testimonial"
            >
              <FontAwesomeIcon icon={faChevronLeft} className="text-sm group-active:-translate-x-1 transition-transform" aria-hidden="true" />
            </button>
            <button
              onClick={() => {
                const container = document.getElementById('feedback-container');
              ...
              aria-label="Next testimonial"
            >
              <FontAwesomeIcon icon={faChevronRight} className="text-sm group-active:translate-x-1 transition-transform" aria-hidden="true" />
            </button>
          </div>
        </div>
      </section>
