    ...
    <div className="flex flex-col">
      ...
      <section className="relative h-screen w-full flex items-center overflow-hidden bg-neutral-900">
        <div className="absolute inset-0 z-0">
          <img
            src={typeof hero === 'object' ? (hero as any).src : hero}
            alt="Hero Background"
      ...
      {/* Announcement banner */}
      <section className='bg-yellow-300 flex justify-center items-center h-10'>
        <p className='text-black font-bold'>This is a test announcement</p>
      </section>
      ...
      <section className="section-padding bg-black text-white overflow-hidden relative">
        ...
        <div className="container mx-auto relative z-10">
          ...
          >
            <Button asChild className="bg-white text-black hover:bg-yellow hover:scale-105 transition-all shadow-premium px-12 rounded-none">
        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-2 px-4">
            <div className="max-w-2xl">
              ...
              <motion.h2
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.1 }}
                className="text-4xl md:text-5xl font-display font-bold uppercase tracking-tighter text-black"
              >
          ...
          <div className="relative">
            <div
              ...
              className="flex space-x-4 md:space-x-8 overflow-x-auto no-scrollbar scroll-smooth py-8 px-4 md:px-24 snap-x snap-mandatory"
            >
              {[...Array(3)].flatMap(() => [
                {
                  name: "Susan Majumder ",
                ...
                >
                  ...
                  <div className="flex items-center mt-auto relative z-10 pt-4 border-t border-neutral-50">
                    <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-neutral-100 mr-4 group-hover:border-border-accent/30 transition-colors">
                      <img src={typeof feedback.image === 'object' ? (feedback.image as any).src : feedback.image} alt={feedback.name} className="w-full h-full object-cover" />
                    </div>
                    <div>
          ...
          <div className="flex space-x-4 mt-8 md:mt-0 justify-end">
            ...
            >
              <FontAwesomeIcon icon={faChevronLeft} className="text-sm group-active:-translate-x-1 transition-transform text-neutral-700 hover:text-white" />
            </button>
            <button
              onClick={() => {
                const container = document.getElementById('feedback-container');
              ...
              className="w-12 h-12 rounded-full border border-neutral-200 flex items-center justify-center hover:bg-black hover:text-white hover:border-black transition-all group cursor-pointer"
            >
              <FontAwesomeIcon icon={faChevronRight} className="text-sm group-active:translate-x-1 transition-transform text-neutral-700 hover:text-white" />
            </button>
          </div>
        </div>
      </section>
