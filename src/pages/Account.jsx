            ...
            <div className="px-8 pb-8 relative">
              <div className="flex flex-col sm:flex-row items-center sm:items-end justify-between -mt-16 sm:-mt-12 space-y-6 sm:space-y-0">
                ...
                <div className="pb-2">
                  <button
                    onClick={signOut}
                    className="flex items-center space-x-2 px-6 py-3 border border-neutral-200 rounded-xl text-sm font-bold uppercase tracking-wider text-black hover:border-red-500 hover:text-red-500 hover:bg-red-50 transition-all duration-300"
                  >
